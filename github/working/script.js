...
import gsap from "../node_modules/gsap/all.js"; // Import core GSAP and all plugins from all.js
import { SplitText } from "../node_modules/gsap/all.js"; // Import SplitText from all.js
import { ScrollToPlugin } from "../node_modules/gsap/all.js";
import { Physics2DPlugin } from "../node_modules/gsap/all.js"; 
 import { PhysicsPropsPlugin } from "../node_modules/gsap/all.js"; 
import { CustomEase } from "../node_modules/gsap/all.js"; 
import { Draggable } from "../node_modules/gsap/all.js"; 
 import { CSSRulePlugin } from "../node_modules/gsap/all.js"; 
 import { EaselPlugin } from "../node_modules/gsap/all.js"; 
import { EasePack  } from "../node_modules/gsap/all.js"; 
 import { Flip } from "../node_modules/gsap/all.js"; 
import { MotionPathPlugin } from "../node_modules/gsap/all.js"; 
import { Observer } from "../node_modules/gsap/all.js"; 
import { PixiPlugin } from "../node_modules/gsap/all.js"; 
import { ScrollTrigger } from "../node_modules/gsap/all.js"; 
 import {TextPlugin  } from "../node_modules/gsap/all.js"; 
import { DrawSVGPlugin } from "../node_modules/gsap/all.js"; 
 import {ScrambleTextPlugin  } from "../node_modules/gsap/all.js"; 
 import { CustomBounce } from "../node_modules/gsap/all.js"; 
 import { CustomWiggle } from "../node_modules/gsap/all.js"; 
 import { GSDevTools } from "../node_modules/gsap/all.js"; 
 import { InertiaPlugin } from "../node_modules/gsap/all.js"; 
 import { MorphSVGPlugin } from "../node_modules/gsap/all.js"; 
import { MotionPathHelper } from "../node_modules/gsap/all.js"; 
 import { ScrollSmoother } from "../node_modules/gsap/all.js"; 




document.addEventListener("DOMContentLoaded", () => {
gsap.registerPlugin (MotionPathHelper, GSDevTools, EasePack, EaselPlugin, CSSRulePlugin, Observer , PixiPlugin, ScrollTrigger, TextPlugin, DrawSVGPlugin, SplitText,Flip,ScrambleTextPlugin, ScrollSmoother, InertiaPlugin, MorphSVGPlugin, CustomWiggle, CustomBounce, ScrollToPlugin,Draggable, CustomEase ,PhysicsPropsPlugin, MotionPathPlugin,Physics2DPlugin);
...
isTransitioning = true;
if (currentTitle) {
const words = currentTitle.querySelectorAll(".word"); gsap.to(words, {
y: "-125%",
duration: 0.75,
delay: 0.5,
stagger: 0.1,
